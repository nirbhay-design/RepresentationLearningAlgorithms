...
# nohup python train.py --config configs/byol.c100.yaml --gpu 3 --model resnet50 --epochs 350 --epochs_lin 100 --save_path byol.c100.r50.e350.pth > logs/byol.c100.r50.e350.log &
...
# nohup python train.py --config configs/simsiam.c100.yaml --gpu 3 --model resnet50 --epochs 350 --epochs_lin 100 --save_path simsiam.c100.r50.e350.pth > logs/simsiam.c100.r50.e350.log &
