...
class DataCifar():
    ...
    def __getitem__(self, idx):
        ...
        if self.algo == "simclr" or self.algo == "dial" or self.algo == "dare" or self.algo == "supcon" or self.algo == "simsiam" or self.algo == "byol" or self.algo == "moco" or self.algo == "barlow_twins":
